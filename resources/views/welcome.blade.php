...
<head>
    ...
    <link rel="stylesheet" href="assets/public/css/open-iconic-bootstrap.min.css">
    ...
    <link rel="stylesheet" href="assets/public/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="assets/public/css/jquery.timepicker.css">


    <link rel="stylesheet" href="assets/public/css/flaticon.css">
    <link rel="stylesheet" href="assets/public/css/icomoon.css">
...
<body>
    ...
    <section class="home-slider owl-carousel">
        <div class="slider-item" style="background-image:url(assets/public/images/bg_1.jpg);">
        ...
        <div class="slider-item" style="background-image:url(assets/public/images/bg_2.jpg);">
            <div class="overlay"></div>
            <div class="container">
                <div class="row no-gutters slider-text align-items-center justify-content-center">
                    <div class="col-md-12 ftco-animate text-center">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-7 py-5 wrap-about pb-md-5 ftco-animate">
                    ...
                    <div class="pb-md-5">
                        <p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its
                            origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country. But nothing the copy said could convince her and so it
                            didn’t take long until a few insidious Copy Writers ambushed her, made her drunk with Longe and Parole and dragged her into their agency, where they abused her for their.
                        </p>
                        <p>When she reached the first hills of the Italic Mountains, she had a last view back on the skyline of her hometown Bookmarksgrove, the headline of Alphabet Village and the
                            subline of her own road, the Line Lane. Pityful a rethoric question ran over her cheek, then she continued her way.</p>
                                ...
                                <div class="item">
                                    <div class="testimony-wrap py-4 pb-5">
                                        ...
                                        <div class="text text-center">
                                            <p class="mb-4">A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        ...
                        </script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://colorlib.com"
    ...
    <script src="assets/public/js/jquery-migrate-3.0.1.min.js"></script>
    ...
    <script src="assets/public/js/jquery.animateNumber.min.js"></script>
    <script src="assets/public/js/bootstrap-datepicker.js"></script>
    <script src="assets/public/js/jquery.timepicker.min.js"></script>
    <script src="assets/public/js/scrollax.min.js"></script>
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
    <script src="assets/public/js/google-map.js"></script>
